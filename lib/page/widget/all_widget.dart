...
// Bold Text
Widget boldTextWidget(String text, double fs,color) {
  return Text(
    text,
    style:
    TextStyle(color: color, fontSize: fs, fontWeight: FontWeight.bold),
  );
}

// Normal Text
Widget normalTextWidget(String text, double fs,color) {
  return Text(
    text,
