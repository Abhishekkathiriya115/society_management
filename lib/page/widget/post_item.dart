          ...
          Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Icon(Icons.more_horiz,color: mainColor,)
              ],
            ),
          ),
          ...
          Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                Row(
              children: <Widget>[
                isLoved ? SvgPicture.asset("assets/images/loved_icon.svg",width: 27,) : SvgPicture.asset("assets/images/love_icon.svg",width: 27,color: Colors.black,),
                const SizedBox(width: 20,),
                 SvgPicture.asset("assets/images/comment_icon.svg",width: 27,color: Colors.black),
                  const SizedBox(width: 20,),
            ...
            Row(
              children: <Widget>[
                ...
                const Text("😍",style: TextStyle(
                 ...
                 const SizedBox(width: 10,),
                 Icon(Icons.add_circle,color: mainColor,size: 18,)
              ],
            )
              ],
            )
